...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Reduce, i.e. apply the block cumulatively using the first block argument
    # as the accumulator and the second arg as the next item from the list.
    # Also, in the second example, you meant 'product', not 'sum'.
  end
  ...
  # guessing: so file variable will go out of scope at the end of the block
